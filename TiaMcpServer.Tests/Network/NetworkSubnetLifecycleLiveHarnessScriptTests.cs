...
/// </para>
/// </summary>
public class NetworkSubnetLifecycleLiveHarnessScriptTests
{
    ...
    public void NoOrdinaryTestInvokesThePhase4LiveHarnessScript()
    {
        ...
        var thisFile = Path.Combine(testDirectory, "Network", "NetworkSubnetLifecycleLiveHarnessScriptTests.cs");
