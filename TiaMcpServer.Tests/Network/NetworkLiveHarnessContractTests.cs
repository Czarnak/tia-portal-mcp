...
public class NetworkLiveHarnessContractTests
{
    ...
    public void NoOrdinaryTestInvokesTheLiveHarnessScript()
    {
        ...
        var thisFile = Path.Combine(testDirectory, "Network", "NetworkLiveHarnessContractTests.cs");
        var phase3ContractFile = Path.Combine(testDirectory, "Network", "NetworkIntrospectionLiveHarnessScriptTests.cs");
