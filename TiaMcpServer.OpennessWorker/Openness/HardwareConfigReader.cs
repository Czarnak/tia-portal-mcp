...
public static class HardwareConfigReader
{
    ...
    internal static HardwarePageCandidateSource CreatePageCandidateSource(
        Project project,
        string? deviceName,
        string? plcName,
        bool includeIoDetails,
        bool includeTagMatches)
    {
        ...
        return new HardwarePageCandidateSource(
            enumerate: () =>
            {
                ...
                if (includeTagMatches)
                {
                    tagIndex = ResolveTagIndex(project, plcName, pageMessages);
                }
                ...
                var deviceCandidates = ProjectDeviceEnumerator
                    ...
                    {
                        var nameEvidence = ReadTypedIdentityString(
            ...
            materialize: descriptor =>
            {
                ...
                {
                    return ReadDevicePageCandidate(
                        device.Device,
                        device.NameEvidence,
                        includeIoDetails,
                        tagIndex);
                ...
                {
                    return ReadSubnetPageCandidate(subnet.Subnet, subnet.SubnetId);
                }
